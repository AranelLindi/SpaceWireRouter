...
set_input_delay -clock [get_clocks sys_clk_pin] -clock_fall -min -add_delay -100.000 [get_ports spw_di]
set_input_delay -clock [get_clocks sys_clk_pin] -clock_fall -max -add_delay 100.000 [get_ports spw_di]
set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay -100.000 [get_ports spw_di]
set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 100.000 [get_ports spw_di]
set_input_delay -clock [get_clocks sys_clk_pin] -clock_fall -min -add_delay -100.000 [get_ports spw_si]
set_input_delay -clock [get_clocks sys_clk_pin] -clock_fall -max -add_delay 100.000 [get_ports spw_si]
set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay -100.000 [get_ports spw_si]
set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 100.000 [get_ports spw_si]
